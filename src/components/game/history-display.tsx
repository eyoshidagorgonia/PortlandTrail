      ...
      >
        <div className="flex justify-end">
          <CollapsibleTrigger asChild>
            <Button
              variant="outline"
              className="justify-center rounded-sm bg-background border p-2 font-headline text-sm hover:no-underline hover:bg-muted transition-colors data-[state=open]:bg-muted flex items-center gap-2"
            >
        ...
        <CollapsibleContent className="bg-background border border-t-0 p-0 rounded-b-sm shadow-lg mt-1">
